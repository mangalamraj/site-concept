...
export const AnimatedShinyText: FC<AnimatedShinyTextProps> = ({
  ...
  return (
    <span
      ...
      className={cn(
        "mx-auto max-w-md text-neutral-600/70 dark:text-neutral-400/70 font-semibold",
        ...
        // Shine gradient
        "bg-gradient-to-r from-blue-600 via-blue-600 via-50% to-transparent dark:via-blue-600/80",
